...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  var tabsControlsMonth = document.querySelector('.tabs__controls--month');
  var tabsControlsHalfYear = document.querySelector('.tabs__controls--half-year');
  var tabsControlsYear = document.querySelector('.tabs__controls--year');
  var tabMonth = document.getElementById('month');
  var tabHalfYear = document.getElementById('half-year');
  var tabYear = document.getElementById('year');
  var gymButton = document.querySelector('.gym__video-button');
  var iframe = document.querySelector('.gym__video-iframe');
  var gymVideoPoster = document.querySelector('.gym__video-poster');
  var phoneNumber = document.querySelector('.phone-number');
  var PHONE_NUMBER_LENGTH = 11;
  gymButton.addEventListener('click', function () {
    iframe.style.opacity = '1';
    gymVideoPoster.style.display = 'none';
    iframe.src += '?autoplay=1';
  });
  tabsControlsMonth.addEventListener('click', function () {
  ...
  tabsControlsHalfYear.addEventListener('click', function () {
  ...
  tabsControlsYear.addEventListener('click', function () {
  ...
  var slider = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__["default"]('.glide', {
    type: 'carousel',
    startAt: 0,
    perView: 4,
    gap: 40,
  ...
  var buttonNext = document.querySelector('.carousel__button-next');
  var buttonPrev = document.querySelector('.carousel__button-prev');
  var carousel = document.querySelectorAll('.carousel__item'); // const carouselLength = carousel.length;
  ...
  window.addEventListener('load', function () {
    ...
    phoneNumber.addEventListener('input', function () {
      var valueLength = phoneNumber.value.length;
